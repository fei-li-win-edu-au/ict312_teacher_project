...
CREATE TABLE products (
    ...
    category CHAR(1), -- Note: For now, 'category' represents gender: 'M' for Male, 'F' for Female
    attribute1 CHAR(1), -- Note: For now, 'attribute1' represents size: 'L' for Large, 'M' for Medium, 'S' for Small
    price DECIMAL(6,2)
);
...
('c2_6.jpg', 'c2_6 name', 'c2_6 label', 'c2_6 description', 'F', 'L', 300.00),
('c2_7.jpg', 'c2_7 name', 'c2_7 label', 'c2_7 description', 'F', 'M', 310.00),
('c2_8.jpg', 'c2_8 name', 'c2_8 label', 'c2_8 description', 'F', 'L', 800.00);
